...
原始数据来自猫眼电影数据库。<br>
通过爬虫补充了豆瓣评分、评分人数与百度指数等变量。<br>
结合《中国统计年鉴》，引入宏观指标（GDP、第三产业增加值、消费水平、影院与银幕数量等）。<br>
...
Merged and one-hot encoded categorical variables such as region, release season, and genre.<br>
Cleaned missing and outlier values.<br>
